@homepage_page2
Feature:  xxx Homepage In Store Private
  As a user
  I want to
  Register to  xxx BIG Card in store private
...
#Tool Tips
  ...
  Scenario: In store private Verify the Rate & Fee Information in accessible menu
    Given I am on xxx in store private home page
    When I select accessible menu
    Then I should see the xxx in store private correct long Rate & Fee Information

  @watir
  Scenario: In store private verify the customer agreement in hamburger menu
    Given I am on xxx in store private home page
    When I select accessible menu
    Then I should see the xxx in store private correct customer agreement
  ...
  Scenario: In store private Verify privacy pdf and opt out
    Given I am on xxx in store private home page
    When I select accessible menu
    Then I should see the xxx in store private correct privacy pdf and opt out
